    ...
    <div className='h-full bg-primary/60'>
      ...
      <div className='w-full h-full bg-gradient-to-r from-primary/10 via-black/30 to-black/10'>
        <div className='container flex flex-col justify-center h-full mx-auto text-center xl:pt-40 xl:text-left'>
          ...
          >
            A Vought oferece produção de treinamentos online e gestão de redes sociais para maximizar sua presença digital de forma estratégica e inovadora.
          </motion.p>
          {/* btn */}
